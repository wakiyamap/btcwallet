...
func newFilterBlocksRequest(batch []wtxmgr.BlockMeta,
	...
	filterReq := &chain.FilterBlocksRequest{
		Blocks:           batch,
		ExternalAddrs:    make(map[waddrmgr.ScopedIndex]monautil.Address),
		InternalAddrs:    make(map[waddrmgr.ScopedIndex]monautil.Address),
...
func (w *Wallet) CreateSimpleTx(account uint32, outputs []*wire.TxOut,
	minconf int32, satPerKb monautil.Amount, dryRun bool) (
...
func (w *Wallet) CurrentAddress(account uint32, scope waddrmgr.KeyScope) (monautil.Address, error) {
	...
	if props != nil {
		err = chainClient.NotifyReceived([]monautil.Address{addr})
		if err != nil {
			return nil, err
		}
...
func (w *Wallet) newAddress(addrmgrNs walletdb.ReadWriteBucket, account uint32,
	scope waddrmgr.KeyScope) (monautil.Address, *waddrmgr.AccountProperties, error) {
...
func (w *Wallet) SendOutputs(outputs []*wire.TxOut, account uint32,
	minconf int32, satPerKb monautil.Amount) (*wire.MsgTx, error) {
...
// in order to allow applications wrapping monawallet to store app-specific data
