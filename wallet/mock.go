...
func (m *mockChainClient) Rescan(*chainhash.Hash, []monautil.Address,
	map[wire.OutPoint]monautil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]monautil.Address) error {
	return nil
}
